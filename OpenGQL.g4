/* =====================================================================================================================
   ...
   It is a collaboration between Microsoft and OpenGQL. It is based on the original work by the GDC's openGQL
   project which in turn aims to faithfully follow the grammar of the
   International Standard ISO/IEC 39075:2024(en) GQL. Related comments tracing back to the openGQL source are
   marked with [openGQL].
